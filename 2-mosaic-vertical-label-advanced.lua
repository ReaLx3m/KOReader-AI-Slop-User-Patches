...
local function patchMosaicMenuItem(MosaicMenuItem)
    ...
    MosaicMenuItem.paintTo = function(self, bb, x, y)
        ...
        -- composite against left edge of cover (vertical strip), rotated 180°
        ...
        local img_angle = (get("direction") == "down") and 90 or 270
        local src_rot = src:rotatedCopy(img_angle)
        src:free()
